...
class GenLibraryFit():
    ...
    def fit_takens(self, printing=True, is_cubic=True, n_embed=7):
        ...
        # Need to keep track of whether we've added u(t) * u(t-τ) to avoid duplicates while also handling either block
        # below possibly being commented out.
        added_0_1_cross_term = False
